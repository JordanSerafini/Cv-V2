        ...
        <div className="Portfolio-Container">
            ...
            <div className="Portfolio-Project-Container"> 
                ...
                <div className="Portfolio-Project Project-2"> 
                    ...
                    <p className="Project-Text">Mes contributions sur GitHub témoignent de mon engagement dans la communauté du code open source. Chaque repository est une opportunité d'apprendre, de partager et de collaborer.</p>
                </div>
